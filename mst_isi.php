...
$a=$mysqli->query("SELECT * from t_anggota ");
$b=mysqli_num_rows($a);
$c=$mysqli->query("SELECT SUM(besar_pinjam) as total_pinjam from t_pinjam")->fetch_assoc();
$d=$mysqli->query("SELECT SUM(besar_angsuran) as total_angsuran from t_angsur")->fetch_assoc();
$e=$mysqli->query("SELECT SUM(besar_tabungan) as total_tabungan from t_tabungan")->fetch_assoc();
$f=$mysqli->query("SELECT SUM(denda) as denda from t_angsur")->fetch_assoc();
