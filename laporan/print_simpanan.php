...
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'  Alamat : Jln.Alamamat Lengkap',0,'L');
$pdf->SetX(4);
...
$pdf->SetFont('Arial','',10);
	...
	while($data=$query->fetch_assoc()){
    	...
    	$d=$mysqli->query("SELECT SUM(besar_simpanan) as pokok from t_simpan where kode_anggota='$kode_ang' and jenis_simpan='pokok'")->fetch_assoc();
		$e=$mysqli->query("SELECT SUM(besar_simpanan) as wajib from t_simpan where kode_anggota='$kode_ang' and jenis_simpan='wajib'")->fetch_assoc();
		$f=$mysqli->query("SELECT SUM(besar_simpanan) as sukarela from t_simpan where kode_anggota='$kode_ang' and jenis_simpan='sukarela'")->fetch_assoc();
...
$no++;}
$a=$mysqli->query("SELECT SUM(besar_simpanan) as total from t_simpan")->fetch_assoc();
