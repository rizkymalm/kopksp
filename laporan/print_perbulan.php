...
$sql=$mysqli->query("SELECT * from t_pinjam where month(tgl_entri)='$bulan' and year(tgl_entri)='$tahun'");
    $nomer=1;
...
$pdf->SetFont('Arial','',10);
	$query = $mysqli->query("SELECT * from t_simpan where month(tgl_entri)='$bulan' and year(tgl_entri)='$tahun'");
	$no=1;	
...
$pdf->SetFont('Arial','',10);
$no=1;
$q=$mysqli->query("SELECT*from t_angsur where month(tgl_entri)='$bulan' and year(tgl_entri)='$tahun'");
