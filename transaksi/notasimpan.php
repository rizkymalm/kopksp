...
$sqla=$mysqli->query("SELECT * from t_anggota where kode_anggota='$kode_anggota'")->fetch_assoc();
$sqlb=$mysqli->query("SELECT * from t_jenis_simpan where kode_jenis_simpan='$kode_jenis'")->fetch_assoc();
?>
...
<table  border="0" align="center">
		...
		<tr align="center">
			...
			<td width="200" colspan="2"><?php echo $_SESSION['kopname'];?></td>
