...
<div class="row mt">
  <div class="col-lg-12">
    <div class="form-panel">
      <h4 class="mb">
        <span class='glyphicon glyphicon-briefcase'></span> Data Petugas<span style="float:right;">
      ...
      <form class="form-inline" role="form">
        <table class="table table-bordered table-striped table-condensed">
          ...
          <tbody>
          <?php
    	      $query=$mysqli->query("SELECT * FROM t_petugas ORDER BY kode_petugas ASC");
            $no=1;
          ...
          ?>
              ...
              <?php 
                $cinta=$mysqli->query("SELECT * from t_user where kode_petugas='$lagi' ")->fetch_assoc();
              ?>
    ...
    <div class="form-panel" style="width:50%;">
      ...
      <form action="petugas/proses_petugas.php?pros=tambah" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text"  readonly class="form-control" name="u_entry" size="54" value="<?php echo $_SESSION['kopname'];?>"/>
        </div>
        <div class="form-group">
...
<?php
  ...
  $kode=$_GET['kode_petugas'];
	$qubah=$mysqli->query("SELECT * FROM t_petugas WHERE kode_petugas='$kode'");
