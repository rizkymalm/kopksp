...
{
	$dfop=$mysqli->query("INSERT into t_pengambilan values('','$kode_a','$kode_t','$besar','$date')");
	$siso=$saldo-$besar;
	$mysqli->query("UPDATE t_tabungan set besar_tabungan='$siso' where kode_tabungan='$kode_t' and kode_anggota='$kode_a'");?>
