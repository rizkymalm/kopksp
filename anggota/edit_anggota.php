...
$sql=$mysqli->query("UPDATE t_anggota SET nama_anggota='$nama',alamat_anggota='$alamat',jenis_kelamin='$jk',pekerjaan='$kerja',tgl_masuk='$tanggal_masuk',telp='$tlp',tempat_lahir='$tmplahir',tgl_lahir='$tgllahir',tgl_entri='$entri' WHERE kode_anggota='$kode'");
if($sql)
{
