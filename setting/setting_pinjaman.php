...
<div class="row mt">
  <div class="col-lg-12">
    <div class="form-panel">
      <h4 class="mb">
        <span class='glyphicon glyphicon-briefcase'></span>Setting Data Pinjaman<span style="float:right;">
      ...
      <form class="form-inline" role="form">
        <table class="table table-bordered table-striped table-condensed">
          ...
          <?php
          $no=1;
          $sql=$mysqli->query("SELECT * FROM t_jenis_pinjam");
...
<?php
	...
	$q=$mysqli->query("SELECT * FROM t_jenis_pinjam WHERE kode_jenis_pinjam='$kode'");
	$data2=$q->fetch_assoc();
?>
<div class="row mt">
  <div class="col-lg-12">
