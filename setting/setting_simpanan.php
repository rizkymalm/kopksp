...
<div class="row mt">
  <div class="col-lg-12">
     <div class="form-panel">
        ...
        <?php
         $am=$mysqli->query("select*from t_jenis_simpan");
...
<?php
$no=1;
$sql=$mysqli->query("SELECT * FROM t_jenis_simpan");
...
<?php
		...
		$qubah=$mysqli->query("SELECT * FROM t_jenis_simpan WHERE kode_jenis_simpan='$kode'");
